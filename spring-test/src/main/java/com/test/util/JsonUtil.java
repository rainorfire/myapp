...
//				.addSerializer(BigDecimal.class, new DaojiaDecimalSerializer())
//				.addDeserializer(Boolean.class, new DaojiaBooleanDeserializer())
//				.addDeserializer(Date.class, new DaojiaDateDeserializer());
